...
const NAV_ITEMS = [
  ...
  { href: "/children", label: "Children", icon: ChildIcon },
...
export function Sidebar() {
  ...
  return (
    <aside className="hidden md:flex flex-col w-60 h-dvh border-r border-border bg-white fixed left-0 top-0 z-40">
...
// Inline SVG icons — minimal, consistent with the warm aesthetic
...
function ObserveIcon({ className }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
